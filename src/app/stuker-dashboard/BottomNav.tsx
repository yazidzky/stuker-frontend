...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    {
      name: "Profile",
      href: "/stuker-dashboard/profile",
      activeIcon: "/icons/profile-purple.svg",
      inactiveIcon: "/icons/profile.svg",
    },
  ];
  return (
    <nav className="absolute bottom-0 h-[10vh] w-[100%] border-t border-gray-300 rounded-t-2xl flex items-center justify-around px-0 sm:px-8  bg-white">
      {navItems.map((item) => {
